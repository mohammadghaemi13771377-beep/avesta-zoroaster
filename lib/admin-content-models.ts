...
export const adminContentModels: AdminContentModel[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "historicalContext", label: "زمینه تاریخی", type: "richtext", required: true, note: "متن پژوهشی کوتاه برای جایگاه تاریخی و سنتی فصل." },
      { name: "ritualContext", label: "زمینه آیینی / تجربه", type: "richtext", required: true, note: "توضیح اینکه فصل چطور به آیین، مطالعه یا تمرین روزانه وصل می‌شود." },
      { name: "keyThemes", label: "کلیدواژه‌ها", type: "json", required: true, note: "آرایه واژه‌ها برای چیپ‌های صفحه، سرچ و پیشنهاد محتوا." },
      { name: "imageAlt", label: "Alt تصویر", type: "json", required: true, note: "متن جایگزین فارسی و انگلیسی برای accessibility و SEO." },
      { name: "relatedChapters", label: "فصل‌های مرتبط", type: "json", required: true, note: "آرایه title, href, reason برای مسیرهای پیشنهادی." },
      { name: "verses", label: "بندهای شاخص", type: "json", required: false, note: "آرایه title, href, summary برای راهنمای مطالعه فصل." },
