export const navItems = [
  { label: "خانه", href: "/" },
  { label: "آیین ورود", href: "/onboarding" },
  { label: "اوستا", href: "/avesta" },
  { label: "جهان", href: "/world" },
  { label: "تور", href: "/tour" },
  { label: "نمایشگاه‌ها", href: "/exhibitions" },
  { label: "نورخانه", href: "/dashboard" },
  { label: "راهنمای روزانه", href: "/daily-light" },
  { label: "کپسول خرد", href: "/wisdom-capsule" },
  { label: "قطب‌نما", href: "/compass" },
  { label: "حریم خصوصی", href: "/privacy-center" },
  ...
  { label: "کارت طلایی", href: "/share-studio" },
  { label: "تالار آیینی", href: "/ritual-room" },
  { label: "نشان‌ها", href: "/achievements" },
  { label: "استمرار", href: "/streak" },
  { label: "تمرین", href: "/practice" },
