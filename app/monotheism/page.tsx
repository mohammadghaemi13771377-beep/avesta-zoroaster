...
const pillars = [
  {
    ...
    description:
      "در روایت سایت، یکتاپرستی زرتشتی با تمرکز بر اهورامزدا به عنوان سرچشمه دانایی، روشنایی و نظم اخلاقی معرفی می‌شود؛ نه با زبان خشک، بلکه با تجربه‌ای قابل فهم برای انسان امروز.",
    accent: "#F2D58A",
  },
  {
  ...
  },
  {
    ...
    description:
      "یکی از جذاب‌ترین لایه‌های پروژه این است که انسان فقط تماشاگر نیست. او با پندار، گفتار و کردار خود در ساختن جهان اخلاقی سهم دارد.",
    accent: "#FFF8EA",
  },
  {
