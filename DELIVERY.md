...
- commit پیشنهادی: `feat: refine luminous UX and storefront`

## آخرین به‌روزرسانی رابط و ادمین

- هدر عمومی خلوت‌تر شد و فروشگاه جای مسیر گات‌ها را در ردیف اصلی گرفت؛ گات‌ها همچنان از اوستا و کاوش در دسترس است.
- حالت نور محیطی، صفحه 404 برنددار، کارت‌های تصویری واقعی خانه و ناوبری موبایل جمع‌شونده اضافه شد.
